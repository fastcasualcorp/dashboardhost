...
export type Profile = { id: string; name: string; sub: string; accent: string; color: string }

export const PROFILES: Profile[] = [
  { id: 'bertamirans', name: 'Bertamiráns', sub: 'REBELL', accent: 'gold', color: '#ffbf10' },
  { id: 'madrid', name: 'Madrid Centro', sub: 'REBELL', accent: 'azul', color: '#3a86ff' },
  { id: 'barcelona', name: 'Barcelona', sub: 'REBELL', accent: 'rosa', color: '#e0457a' },
  { id: 'central', name: 'Administración', sub: 'Central', accent: 'violeta', color: '#8b6df0' },
]

function HornsAvatar({ color }: { color: string }) {
  return (
    <svg className="pf-horns" viewBox="0 0 48 48" fill="none" aria-hidden="true">
      <path
        d="M6 13c0 11 6 17 18 17S42 24 42 13c-5 5-9 7-12 7 3-3 4-6 4-9-4 4-7 5-10 5s-6-1-10-5c0 3 1 6 4 9-3 0-7-2-12-7Z"
        fill={color}
      />
      <circle className="eye" cx="19" cy="26" r="2.4" fill="#0a0a0c" />
      <circle className="eye" cx="29" cy="26" r="2.4" fill="#0a0a0c" />
    </svg>
  )
}
